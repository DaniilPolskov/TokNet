  ...
  return (
    <div className="profile-container">
      <div className="profile-header">
        ...
        <div className="stats">
          <div className="transaction-count">1653</div>
          <div className="stats-label">Transaction count</div>
          <div className="lot-quantity">4</div>
          <div className="stats-label">Lot quantity</div>
        </div>
      </div>
