...
from . import views
from .views import ExchangeOrderHistoryView, RegisterView, LoginView, ProfileUpdateView, profile_view, get_qr_code, verify_2fa, disable_2fa, check_2fa_enabled, CompleteOrderView, CancelOrderView, ExchangeCreateView, OrderStatusView, RegisterView, LoginView, ProfileUpdateView, profile_view
